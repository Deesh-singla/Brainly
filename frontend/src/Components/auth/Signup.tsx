    ...
    return (
        <main className="h-[90vh] flex items-center justify-center bg-sign-bg">
            <div className="flex flex-col gap-4 p-6 bg-body-bg rounded-lg shadow-md w-[400px] dark:text-white">
                ...
                <p className="text-center text-lg text-gray-600 dark:text-subheading">Sign up to access your second brain!</p>
                ...
                <Button variant={"submitSecondary"} text={"Sign up"} size={"md"} onClick={() => { handleClick() }} />
