...
export default function Sidebar() {
    ...
    return (
        <div className='w-full h-full bg-white dark:bg-sign-bg shadow-lg border-r border-gray-200 dark:border-gray-700'>
            <div className='flex items-center p-4 pt-6 gap-3 border-b border-gray-200 dark:border-gray-700'>
            ...
            <nav className='p-4 space-y-2'>
                {navBtns.map((navEl: navInterface, i: number) => (
                    <div className='flex items-center gap-3 p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 cursor-pointer' onClick={() => getData(navEl.type)} key={i}>
